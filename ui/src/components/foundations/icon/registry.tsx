...
const socialX: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
const socialReddit: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg id='Layer_1' data-name='Layer 1' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 256 256' {...props}>
    <path
      fill='currentColor'
