    ...
    variants: {
      variant: {
        ...
        link: cn(
          ...
          'underline underline-offset-[4px] decoration-primary/40 decoration-1',
          'hover:decoration-primary/20',
          'dark:text-primary dark:hover:text-primary/90',
          'dark:decoration-primary/90 dark:hover:decoration-primary/80',
