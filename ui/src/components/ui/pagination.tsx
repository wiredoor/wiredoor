...
type PaginationLinkProps = {
  isActive?: boolean;
} & Pick<React.ComponentProps<typeof Button>, 'className' | 'size' | 'children' | 'aria-label' | 'aria-current' | 'onClick'>;

function PaginationLink({ className, isActive, size = 'icon-sm', children, ...props }: PaginationLinkProps) {
  return (
    <Button
      size={size}
