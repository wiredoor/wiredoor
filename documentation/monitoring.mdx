---
title: "Wiredoor Monitoring: Grafana Dashboards for NGINX & WireGuard Metrics"
description: 
  Enable native monitoring in Wiredoor v1.3.0+ using Prometheus and Grafana. Track VPN activity and HTTP traffic with official dashboards for NGINX and WireGuard. Expose Grafana securely using Wiredoor_Local without external dependencies.
keywords: ["grafana", "prometheus", "nginx metrics", "wireguard stats", "docker monitoring", "http traffic"]
---
...
![Wiredoor Dashboard to Monitor Wireguard](/images/docs/monitoring/wiredoor-wireguard-monitoring-dashboard.png)

### Wiredoor: Nginx Monitoring

This dashboard provides visibility into your public HTTP traffic:

![Wiredoor Dashboard to Monitor Nginx](/images/docs/monitoring/wiredoor-nginx-monitoring-dashboard.png)
