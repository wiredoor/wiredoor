---
title: "Wiredoor Docker Gateway: Expose Docker Services via Secure VPN Tunnel"
description: 
  Set up the Wiredoor Docker Gateway to expose containers securely over WireGuard VPN. Learn how to connect your Docker services to Wiredoor, resolve service names with dnsmasq, and expose private apps using gateway nodes.
keywords: ["docker gateway", "wireguard vpn", "container network", "docker-compose", "private services", "docker exposure"]
---
