---
title: "Wiredoor Security: VPN Tunnels, Tokens, CrowdSec & IP Restrictions"
description: 
  Discover how Wiredoor secures your private services with WireGuard VPN tunnels, SSL certificates, token-based authentication, IP restrictions, and CrowdSec integration. Follow best practices for safe service exposure in self-hosted environments.
keywords: ["encryption", "ip restriction", "crowdsec", "access tokens", "ssl certificates", "vpn security"]
---
...
<Callout type="info" emoji="🛡️">
  ...
  [How to block malicious IPs in Wiredoor using CrowdSec](/guides/how-to-block-malicious-ip-in-wiredoor-using-crowdsec-firewall-bouncer)
</Callout>
