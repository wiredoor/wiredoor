---
title: "Wiredoor CLI: Command-Line Tool to Expose Private Services Securely"
description: 
  Use the Wiredoor CLI to register nodes, expose HTTP/TCP/UDP services, and manage VPN tunnels securely from any terminal. Ideal for headless servers, Docker, and IoT devices. Automate connectivity with systemd or OpenRC support.
keywords: ["wiredoor cli", "expose services", "vpn connection", "http exposure", "tcp exposure", "private networks"]
---
