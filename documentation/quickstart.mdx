---
title: "Wiredoor Quickstart Guide: Deploy and Expose Your First Private Service Quickly"
description: 
  Deploy Wiredoor Server on a public VPS and expose private services over secure WireGuard tunnels in minutes. Follow this quickstart to install, configure, and connect with the CLI. Supports Docker, HTTPS, custom domains, and secure tunneling.
keywords: ["setup guide", "docker", "vpn server", "service exposure", "wireguard", "installation"]
---
