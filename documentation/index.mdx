---
title: "Wiredoor Documentation: Secure Ingress for Private Networks with WireGuard"
description: 
  Self-hosted and open-source Ingress-as-a-Service platform powered by WireGuard. Expose Docker, Kubernetes, IoT, or on-prem services securely without opening firewall ports. Learn how to deploy and manage private-to-public ingress with Wiredoor.
keywords: ["wireguard", "reverse proxy", "self-hosted ingress", "vpn tunnel", "docker", "kubernetes"]
---
...
→ Ready to deploy? Continue to the [Installation Guide](/documentation/quickstart)
