---
title: "Wiredoor Kubernetes Gateway: Secure Ingress for Private Clusters"
description: 
  Use Wiredoor Kubernetes Gateway to expose services from private clusters securely over WireGuard VPN. Deploy via Helm, avoid bastion hosts or cloud tunnels, and enable automatic SSL, DNS resolution, and network policies in air-gapped or on-prem environments.
keywords: ["kubernetes gateway", "kubernetes vpn tunnel", "private cluster", "service exposure"]
---
