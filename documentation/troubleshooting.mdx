---
title: "Wiredoor Troubleshooting Guide: Fix Common Connectivity & VPN Issues"
description: 
  Resolve common Wiredoor issues including VPN connectivity, service exposure, DNS resolution, SSL warnings, token errors, and Kubernetes access. Follow step-by-step fixes for CLI, server, and gateway nodes using Docker and Helm.
keywords: ["connection error", "invalid token", "ssl issues", "dns resolution", "kubernetes access", "logs"]
---
